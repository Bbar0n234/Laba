...
def analyse_entered_value(text_to_encrypt, key, is_hex_input_value=False):
    """
    :param text_to_encrypt:
    :param key:
    :param is_hex_input_value:
...
class DocsClass():
    ...
    def cipher(self, text, key, rounds):
        """
        \brief Метод принимает на вход текст, ключ и количество раундов, возвращает пару из шифрованного-дешифрованного сообщения
        \param :param text: текст для шифрования
        \param :param key: ключ
        \param :param rounds: количество раундов
        \return return: возвращает пару из шифрованного-дешифрованного сообщения
        """
